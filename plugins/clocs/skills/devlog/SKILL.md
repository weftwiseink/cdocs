...
3. Create `clocs/devlogs/YYYY-MM-DD-feature-name.md` using the template below.
4. If `clocs/devlogs/` doesn't exist, suggest running `/cloc:init` first.
...
- **Screenshots:** Visual changes with captions. Save to `clocs/_media/YYYY-MM-DD-description.png`.
