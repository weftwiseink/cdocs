...
> BLUF(mjr/clocs/nit-fix): A haiku-powered `/cloc:nit_fix` skill that reviews documents for easily-amended rules violations and fixes them directly.
...
CLocs has a growing set of writing conventions (`rules/writing-conventions.md`) that are easy to violate and tedious to enforce manually.
...
- Should it operate on a single file or scan all clocs?
