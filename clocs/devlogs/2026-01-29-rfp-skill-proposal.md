...
Stub an RFP proposal for a `/cloc:rfp` skill that creates `request_for_proposal` stubs.
...
| File | Description |
|------|-------------|
| `clocs/proposals/2026-01-29-rfp-skill.md` | RFP stub for the rfp skill |
| `clocs/devlogs/2026-01-29-rfp-skill-proposal.md` | This devlog |
