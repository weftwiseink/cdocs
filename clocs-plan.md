...
CLocs is a doc structure and collection of claude skills for organizing work, reports etc.
...
### frontmatter
Every cloc should have have frontmatter with the following fields:

```yaml
---
review_of?: clocs/.../2026-01-29-doc-name.md
first_authored:
...
4. type: correspond to each subdir under clocs. May be expanded in the future
...
### media
media should always be dated, saved to `clocs/_media`, and embedded into the relevant doc.
...
4. we'll want a skill for setting up the scaffolding for clocs in a repo, and updating the CLAUDE.md with stuff that doesn't make sense to be tucked in a skill 
